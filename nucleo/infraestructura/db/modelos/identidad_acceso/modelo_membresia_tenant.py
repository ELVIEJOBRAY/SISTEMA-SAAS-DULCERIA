...
class ModeloMembresiaTenant(Base):
    __tablename__ = "membresias_tenant"
    __table_args__ = (
        UniqueConstraint("tenant_id", "usuario_id", "rol_id", name="uq_membresias_tenant"),
    )
    ...
    usuario: Mapped["ModeloUsuario"] = relationship(back_populates="membresias_tenant")
    rol: Mapped["ModeloRol"] = relationship(back_populates="membresias_tenant")
