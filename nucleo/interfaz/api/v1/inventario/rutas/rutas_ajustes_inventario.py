...
from nucleo.aplicacion.inventario.casos_uso.registrar_ajuste_inventario import (
...
from nucleo.interfaz.api.v1.inventario.esquemas.peticion_registrar_ajuste_inventario import (
    PeticionRegistrarAjusteInventario,
)
from nucleo.interfaz.api.v1.inventario.esquemas.respuesta_movimiento_inventario import (
    RespuestaMovimientoInventario,
)

enrutador_ajustes_inventario = APIRouter(
    prefix="/inventario/ajustes",
    tags=["Inventario - Ajustes"],
)


@enrutador_ajustes_inventario.post(
    "",
    response_model=RespuestaMovimientoInventario,
    status_code=status.HTTP_201_CREATED,
)
def registrar_ajuste_inventario(
    peticion: PeticionRegistrarAjusteInventario,
    ...
    comando = ComandoRegistrarAjusteInventario(
        ...
        es_incremento=peticion.es_incremento,
    ...
    caso_uso = RegistrarAjusteInventario(servicio)
