...
from nucleo.aplicacion.inventario.casos_uso.registrar_entrada_inventario import (
...
from nucleo.interfaz.api.v1.inventario.esquemas.peticion_registrar_entrada_inventario import (
    PeticionRegistrarEntradaInventario,
)
from nucleo.interfaz.api.v1.inventario.esquemas.respuesta_movimiento_inventario import (
    RespuestaMovimientoInventario,
)

enrutador_entradas_inventario = APIRouter(
    prefix="/inventario/entradas",
    tags=["Inventario - Entradas"],
)


@enrutador_entradas_inventario.post(
    "",
    response_model=RespuestaMovimientoInventario,
    status_code=status.HTTP_201_CREATED,
)
def registrar_entrada_inventario(
    peticion: PeticionRegistrarEntradaInventario,
    ...
    comando = ComandoRegistrarEntradaInventario(
    ...
    caso_uso = RegistrarEntradaInventario(servicio)
